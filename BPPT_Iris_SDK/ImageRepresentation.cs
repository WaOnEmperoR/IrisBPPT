...
namespace BPPT_Iris_SDK
{
    public class ImageRepresentation
    {
        ...
        public ImageRepresentation(int[,] _pixel)
        {
            g_pixel = _pixel;
        ...
        private int[,] borderFollowing_02()
        {
            ...
            //pi.WriteToPath(res_folder + "\\border_following_" + apa + ".pgm", temp_02);
        ...
        public int[,] FourierDescriptorRepresentation_02(int input, String type, string apa)
        {
            ...
            PGM_Iris pi = new PGM_Iris(temp.GetLength(1), temp.GetLength(0));
        ...
        public int[,] FourierDescriptorRepresentation_03(int _input, String _type)
        {
            int[,] temp = borderFollowing();
            int k, u;
