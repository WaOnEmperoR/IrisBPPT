...
namespace BPPT_Iris_SDK
{
    public class Extract_02
    {
        ...
        private void RunLocalization()
        {
            ...
            try
            {
                ImageRepresentation_03 asd = new ImageRepresentation_03(new PGM_Iris(folderResult + "\\anim_black_iris_otsu.pgm").Pixels);
                int[,] pixel2 = asd.FourierDescriptorRepresentation_02(5, "original", "iris");
                pgmWriter.WriteToPath(folderResult + "\\ori_border_iris.pgm", pixel2);

                asd = new ImageRepresentation_03(new PGM_Iris(folderResult + "\\anim_black_pupil_otsu.pgm").Pixels);
                pixel2 = asd.FourierDescriptorRepresentation_02(5, "original", "pupil");
